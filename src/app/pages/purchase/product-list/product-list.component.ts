...
export class ProductListComponent implements OnInit {
  constructor(
    ...
    private servicePurchase: PurchaseService,
  ...
  getDetails(product: iProduct) {
    ...
    this.servicePurchase.productDetail.next(product)
    console.log('Obteniendo detalles del producto con ID:', product);
    this.router.navigate(['/pages/compras/productos/detalle',product.id])
  }
}
